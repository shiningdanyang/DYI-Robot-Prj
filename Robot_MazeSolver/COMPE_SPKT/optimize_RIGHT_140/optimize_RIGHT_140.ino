...
const int initSpeed[2] = {110, 110}; //230//180//210//140
...
int PIDTurn;
int minSpeed =0;// 50 ok//40//20//20
int maxSpeed =240;// 90 ok//80 ok//180//230//200
//////////////////////////////////////////////////////
...
void loop()
{
  ...
  timeStart = millis();
  while (millis() - timeStart < 400)//500
  {
    /////////////////////Left Hand//////////////////////////////////
    readSensors();
  ...
  while (1)
  {
    /////////////////////Left Hand//////////////////////////////////
    readSensors();
    if(sensor[left]==0) sensor[left] = 60;/////////////////////
    printValue(); //debug
    if (sensor[front] > frontThreshold)
    {
      calculatePID(leftHand);
