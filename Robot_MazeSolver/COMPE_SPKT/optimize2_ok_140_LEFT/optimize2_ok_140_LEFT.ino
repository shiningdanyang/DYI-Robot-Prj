...
const int initSpeed[2] = {120, 120}; //230//180//210//140
...
int PIDTurn;
#define minSpeed 25// 50 ok//40//20//20
#define maxSpeed 230// 90 ok//80 ok//180//230//200
//////////////////////////////////////////////////////
...
void loop()
{
  ...
  while (1)
  {
    /////////////////////Left Hand//////////////////////////////////
    readSensors();
    if(sensor[right]==0) sensor[right] = 60;/////////////////////
    printValue(); //debug
    if (sensor[front] > frontThreshold)
    {
      calculatePID(rightHand);
