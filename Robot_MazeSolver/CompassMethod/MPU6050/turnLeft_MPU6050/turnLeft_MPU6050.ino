...
SimpleKalmanFilter filterAngle(2, 2, 0.9);
#define left 0
#define right 1
int trig[] = {A1, A3};
int echo[] = {A0, A2};
...
//int initialSpeedLeft = 60;
//int initialSpeedRight = 60;//75
int initialSpeedLeft = 230;
...
void motorControl()
{
  ...
  int left_motor_speed = initialSpeedLeft - PID_value;
  int right_motor_speed = initialSpeedRight + PID_value;
