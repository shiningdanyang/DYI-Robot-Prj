char path[30] = {};
int readLength = 0;
int bias = 2; //turn angle too sharp -> increase bias
...
{
  digitalWrite(trig[_position], 0);  // tắt chân trig
  delayMicroseconds(2);
  digitalWrite(trig[_position], 1);  // phát xung từ chân trig
...
void replay()
{
  ...
  else  //nếu có ngã rẽ
  {
    ...
    {
      runSkip(initialSpeedLeft, leapTime);
      runStraight();
    }
    readLength++;
  }
